...
func (c *Connection) Connect(org, user, pass string) error {
	...
	// XXX - Pre VSD version 4.0 this was: c.Url+"/nuage/api/v1_0/me"
	authurl := c.Url + "/nuage/api/v4_0/me"

	// Get APIkey + its timestamp from "authurl"
	...
	log.Debugf("Attempting to make connection to: %s", authurl)
